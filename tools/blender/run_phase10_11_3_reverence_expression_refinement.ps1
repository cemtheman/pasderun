...
Write-Host "Hand gap:        $($data.upper_refinement.selected_hand_geometry.gap_hand_chain_fraction) hand-chain"
Write-Host "Hand asymmetry:  $($data.upper_refinement.selected_hand_geometry.side_offset_asymmetry_hand_chain_fraction) hand-chain"
