"""Phase 10.11.3 reverence upper-body expression refinement proof."""
...
def render_previews(
    ...
    for view in contract["preview"]["views"]:
        ...
        path=preview_dir/f"opening_reverence_refined_{view.lower()}.png"
        if path.exists():
            path.unlink()
...
def main() -> None:
    ...
    print("PHASE10_11_3_REVERENCE_EXPRESSION_AUTOMATED_PROOF=PASS")
