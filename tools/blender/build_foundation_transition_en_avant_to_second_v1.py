"""Phase 10.7.2 en_avant -> second foundation-motion prototype.
...
def render_previews(
    ...
    for view_name in contract["preview"]["views"]:
        ...
        path = preview_dir / (
            f"en_avant_to_second_{view_name.lower()}.mp4"
        )
        if path.exists():
            path.unlink()
...
def main() -> None:
    ...
    report = {
        ...
        "human_visual_gate": {
            ...
            "question": "Does this look like a dancer moving from en avant to second?",
    ...
    print("PHASE10_7_2_FOUNDATION_MOTION_AUTOMATED_PROOF=PASS")
