...
$outputGlb = Join-Path $Repo "build\phase10_4\low_poly_girl_authored_v1.glb"
$report = Join-Path $Repo "build\phase10_4\opening_reverence_v1_report.json"
$blendOutput = Join-Path $Repo "build\phase10_4\opening_reverence_v1.blend"
...
Write-Host ""
Write-Host "PHASE 10.4.1 PIPELINE PASS"
